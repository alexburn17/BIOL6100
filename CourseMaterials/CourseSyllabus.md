...
**Lecture:** Tuesday, Thursday  1:15 - 2:30 pm, Perkins Building 003   
**Lab:** Wednesday, 1:10 pm - 3:40 pm, 129 Marsh Life Science 

## Instructors

**Lecture:** Alexander Burnham
220 Jeffords                    
[pburnham@uvm.edu](mailto:pburnham@uvm.edu)   
...
2. Foundational methods in computer programming in R and Python (data structures, functions, control structures, input and output) that will allow you to construct computer models and to easily learn other computer languages.
...
* **Complete the assignments in time for the Portfolio Checks (4 February, 4 March, and 8 April), so that your final course grade will not be lowered!**
